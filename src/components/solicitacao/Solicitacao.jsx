    ...
    <div className={styles.layoutSolicitacao}>
      ...
      <div className={styles.containerPrincipalSolicitacao}>
        ...
        <main className={styles.mainSolicitacao}>
          ...
          <footer className={styles.footerpai}>
            ...
            <div className={styles.botoesfooter}>
              <button className={styles.enviarpara}>Enviar para Analize</button>

              <button className={styles.botaocancelar}>Cancelar Solicitação</button>
            </div>
